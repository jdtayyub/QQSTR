...
%Placing \ before the _ to make it escaped from latex formatiing
for i = 1: size(xTickLabels,1)
  ind = find(xTickLabels{i}=='_')
  p1 = xTickLabels{i}(1:ind-1)
  p2 = xTickLabels{i}(ind+1:end)
  xTickLabels{i} = [p1 '\_' p2];
end
